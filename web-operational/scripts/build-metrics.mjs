/**
 * docs/metrics_operational.yml → web-operational/data/metrics.json
 *
...
const SRC = join(HERE, "..", "..", "docs", "metrics_operational.yml");
...
console.log(`✓ ${compiled.length} метрик → web-operational/data/metrics.json`);
