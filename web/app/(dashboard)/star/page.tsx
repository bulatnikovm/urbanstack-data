      ...
      <PageBody>
        ...
        >
          <Panel
            ...
            note="Стовпчик — 100%. Підпис стоїть на частках від 3,5%: на менших цифри накладаються одна на одну. Наведи на місяць — покаже всі сім категорій із кількістю людей і точною часткою."
            action={
              <ExportXlsx
