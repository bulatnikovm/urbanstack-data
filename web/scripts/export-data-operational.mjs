/**
 * BigQuery → JSON. Вивантажує операційні mart'и у web/data/operational/.
 *
 * Автентифікація — та сама ADC, що й у dbt (`gcloud auth application-default login`).
 *
 *   node scripts/export-data-operational.mjs
 *
...
const OUT_DIR = join(dirname(fileURLToPath(import.meta.url)), "..", "data", "operational");
...
async function main() {
  ...
  console.log(`\n✓ ${total} таблиць → web/data/operational/`);
