...
/**
 * Українська форма числівника: 1 відхилення · 2-4 відхилення · 5 відхилень.
 *
 * ⚠️ Форм ТРИ, а не дві. Розвилка «одне / решта» — найпоширеніша помилка й
 * дає «4 відхилень» замість «4 відхилення»: для 2-4 українська бере родовий
 * ОДНИНИ, який часто збігається з називним однини, а родовий множини
 * («відхилень») починається з п'яти. Винятки 11-14 йдуть за загальним
 * правилом (11 відхилень, а не «11 відхилення»).
 */
