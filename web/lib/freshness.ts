 ...
 *
 * Поріг — 10:00, і він виведений з обіцянки, а не зі смаку: Cloud Scheduler
 * запускає оновлення о 08:00 за Києвом, повний цикл (прогін GitHub ~8 хв +
 * пересборка Vercel) укладається в чверть години, і о 09:00 дані мають бути
 * на екрані. Година зверху — запас на повільний `dbt build` чи чергу
 * Vercel. Після десятої вчорашній зріз означає рівно те, що написано в
