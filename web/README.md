...
Щодоби о 06:17 UTC, зі страхувальним прогоном о 12:17 (і на кнопку в
Actions) — [`.github/workflows/refresh-dashboard.yml`](../.github/workflows/refresh-dashboard.yml):
...
**Чому два розклади й чому не «рівно о шостій».** `schedule` у GitHub
Actions — не гарантія, а спроба: під навантаженням запуски відкладаються або
МОВЧКИ скасовуються. 27.08.2026 «шоста ранку» стартувала о 17:23 UTC, 28.08
не стартувала взагалі — дашборд стояв на позавчорашніх даних, і в Actions
при цьому не було жодної червоної позначки. Тому хвилина не нульова (на
початок години припадає пік черги) і є другий прогін опівдні. Подвійної
роботи він не робить: job `guard` дивиться на дату останнього коміту в
`web/data/` і пропускає прогін, якщо сьогодні дані вже оновились.
...
як працює конвеєр: зріз сьогоднішній чи ні. До 12:00 за Києвом учорашній
зріз ще вважається нормою (прогін міг затриматись — GitHub регулярно
зсуває його на 40-60 хвилин), після — це «не оновилось».
