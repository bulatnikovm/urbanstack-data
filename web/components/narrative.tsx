 ...
 *
 * ⚠️ Поки функція на обкатці — видно лише глядачам зі списку LAB_EMAILS
 * (`lib/lab.ts`). Решта не бачить ні тексту, ні позначок аномалій: блок
 * просто не рендериться, а не показується порожнім.
 */
