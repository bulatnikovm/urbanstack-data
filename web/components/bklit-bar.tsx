 ...
 *
 * ⚠️ Кути в стеку — ПРЯМІ (`lineCap={0}`), і це не недогляд. Сегмент
 * малюється звичайним `<rect rx>`, а rx закруглює всі ЧОТИРИ кути, тож
 * будь-яке скруглення в стеку дає артефакт: або нижній сегмент з гострими
 * кутами під заокругленим верхнім (при stackGap=0 скруглення отримує лише
 * остання серія), або верхній сегмент з круглим НИЗОМ, що висить над
 * нижнім капсулою. Per-corner радіуса `<rect>` не має, тому для стеку
 * чесно прямі кути + невеликий зазор, а скруглення лишаємо групованим
 * стовпчикам, де стовпчик один і двозначності немає.
 *
