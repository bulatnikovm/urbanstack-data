 ...
 *
 * Серії йдуть ПОРУЧ (групою), не одна на одній.
 *
 * ⚠️ Скруглення живе тільки в ГРУПОВАНОМУ режимі — і це причина, чому
 * дашборд групує, а не стекує. Сегмент малюється звичайним `<rect rx>`, а
 * rx закруглює всі ЧОТИРИ кути, per-corner радіуса `<rect>` не має. У
 * стеку це дає артефакт у будь-якому варіанті: або нижній сегмент з
 * гострими кутами під заокругленим верхнім (stackGap=0 → скруглення лише
 * останній серії), або верхній сегмент капсулою з круглим НИЗОМ над
 * нижнім. У групі стовпчик один — двозначності немає, скруглення чисте.
 *
