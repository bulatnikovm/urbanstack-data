  ...
  return (
    ...
    >
      ...
      <span className="text-muted-foreground">
        ...
        за Києвом.{" "}
        {late
          ? "Нічне оновлення не пройшло: GitHub не гарантує запуск за розкладом і під навантаженням мовчки його пропускає. Опівдні є страхувальний прогін."
          : "Оновлення не проходить не перший день — це вже не випадковий пропуск розкладу, варто подивитись логи прогону."}{" "}
