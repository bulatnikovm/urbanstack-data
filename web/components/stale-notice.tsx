  ...
  return (
    ...
    >
      ...
      <span className="text-muted-foreground">
        ...
        за Києвом.{" "}
        {late
          ? "Ранкове оновлення о 08:00 не пройшло — тобто або задача Cloud Scheduler не спрацювала (найімовірніше скінчився токен), або впав сам прогін. Опівдні є страхувальний запуск від GitHub."
